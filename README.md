...
```
upi-ecosystem-health-analysis/
├── dashboard/                   4 Power BI dashboard screenshots
├── data/
...
```bash
git clone https://github.com/MrunalShekade/upi-ecosystem-health-analysis.git
cd upi-ecosystem-health-analysis
python -m venv venv
...
python scripts/04_transaction_value_at_risk.py
